...
"[project]/node_modules/jiti/dist/jiti.cjs [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(()=>{
    ...
    (()=>{
        ...
        const e = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/os-browserify/browser.js [client] (ecmascript)");
        var t = [
            509,
            0,
            227,
        ...
        function pathe_M_eThtNZ_cwd() {
            return "undefined" != typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"] && "function" == typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].cwd ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].cwd().replace(/\\/g, "/") : "/";
        }
        ...
        }, _e = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/native-url/index.js [client] (ecmascript)"), Ee = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/assert/assert.js [client] (ecmascript)"), be = __turbopack_context__.r("[project]/node_modules/next/dist/build/polyfills/process.js [client] (ecmascript)"), Se = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/path-browserify/index.js [client] (ecmascript)"), ke = (()=>{
            const e = new Error("Cannot find module 'node:v8': Unsupported external type Url for commonjs reference");
            e.code = 'MODULE_NOT_FOUND';
            throw e;
        })(), we = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/util/util.js [client] (ecmascript)"), Ie = new Set(le.builtinModules);
        ...
        function _resolve(e, t = {}) {
            ...
            0 === s.length && s.push(new URL(pathToFileURL(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].cwd())));
            const r = [
                ...s
            ];
        ...
        const dt = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/crypto-browserify/index.js [client] (ecmascript)");
        ...
        }), xt = typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"] < "u" && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env && ("TURBOPACK compile-time value", "development") || "", vt = [
            [
                "APPVEYOR"
            ],
            [
        ...
        const Lt = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/tty-browserify/index.js [client] (ecmascript)"), Ot = Lt?.WriteStream?.prototype?.hasColors?.() ?? !1, base_format = (e, t)=>{
            if (!Ot) return (e)=>e;
            const i = `[${e}m`, s = `[${t}m`;
            return (e)=>{
                const r = e + "";
        ...
        function debug(e, ...t) {
            ...
            const i = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].cwd();
            console.log(Ft([
                "[jiti]",
        ...
        function _jsonEnv(e, t) {
            const i = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env[e];
            if (!(e in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env)) return t;
            try {
                return JSON.parse(i);
            } catch  {
                return t;
        ...
        const Gt = (()=>{
            ...
            e.code = 'MODULE_NOT_FOUND';
            throw e;
        })(), Ht = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/vm-browserify/index.js [client] (ecmascript)");
        ...
        function prepareCacheDir(t) {
            if (!0 === t.opts.fsCache && (t.opts.fsCache = function(t) {
                ...
                let s = (0, e.tmpdir)();
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env.TMPDIR && s === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].cwd() && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env.JITI_RESPECT_TMPDIR_ENV) {
                    const t = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env.TMPDIR;
                    delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env.TMPDIR, s = (0, e.tmpdir)(), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env.TMPDIR = t;
                }
        ...
        function eval_evalModule(e, t, i = {}) {
            ...
            try {
                ...
                "SyntaxError" === t.name && i.async && e.nativeImport ? (debug(e, "[esm]", "[import]", "[fallback]", r), f = function(e, t) {
                    const i = `data:text/javascript;base64,${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(`export default ${e}`).toString("base64")}`;
        ...
        function createJiti(e, t = {}, i, s = !1) {
            ...
            e || (e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].cwd()), !s && isDir(e) && (e = pathe_M_eThtNZ_join(e, "_index.js"));
            const p = pathToFileURL(e), l = [
                ...r.extensions
            ].filter((e)=>".js" !== e), u = i.createRequire(Jt ? e.replace(/\//g, "\\") : e), d = {
                filename: e,
                url: p,
                opts: r,
                alias: n,
...
"[project]/node_modules/jiti/lib/jiti.mjs [client] (ecmascript)", (() => {{

throw new Error("An error occurred while generating the chunk item [project]/node_modules/jiti/lib/jiti.mjs [client] (ecmascript)\n\nCaused by:\n- the chunking context (unknown) does not support external modules (request: node:module)\n\nDebug info:\n- An error occurred while generating the chunk item [project]/node_modules/jiti/lib/jiti.mjs [client] (ecmascript)\n- Execution of <ModuleChunkItem as EcmascriptChunkItem>::content_with_async_module_info failed\n- Execution of *EcmascriptChunkItemContent::new failed\n- Execution of EcmascriptModuleContent::new failed\n- the chunking context (unknown) does not support external modules (request: node:module)");

}}),
]);

//# sourceMappingURL=node_modules_jiti_093e1d92._.js.map